...
/*********************************************************************************/
/**
 * defsIniHandler class
 *
 * @author Kjell-Inge Gustafsson, kigkonsult <ical@kigkonsult.se>
 * @since 1.0 - 2015-05-26
 */
class defsIniHandler extends defsFileHandler implements defsSourceInterface {
/**
 * fetch values from ini file
 *
 * key/value rows, delimiter '='
 ...
 */
  public static function loadData( array $source ) {
    ...
    if( FALSE === ( $output = parse_ini_file( $source['path'], TRUE )))
